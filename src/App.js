  ...
  return (
    <Wrapper className="App">
      ...
      <ContentWrapper>
        <Container>
          <TextContainer>
            <Title>HI, I'M CALVIN. WELCOME TO MY PORTFOLIO</Title>
            <Description>
              Visual Designer passionate about crafting immersive visuals,
              dynamic compositions, and striking aesthetics. With a playful yet
              precise approach, I create designs that leave a lasting
              impression.
            </Description>
          </TextContainer>
          <ButtonContainer>
...
const ButtonContainer = styled.div`
  ...
  gap: 20px;
  background: #1a1a1a; /* Removed gradient, replaced with solid color */
