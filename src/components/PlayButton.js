...
const Container = styled.div`
  display: flex;
  gap: 12px;
  background: linear-gradient(180deg, #e63946 0%, #d62828 92.5%);
  box-shadow: 0px 8px 10px rgba(230, 57, 70, 0.2),
...
const Circle = styled.div`
  width: 24px;
  height: 24px;
  background: linear-gradient(180deg, #9b2226 0%, #e76f51 100%);
...
const MiniCircle = styled.div`
  width: 14px;
  height: 14px;
  background: linear-gradient(180deg, #ffb4a2 0%, #fcd5ce 100%);
  border: 1px solid rgba(255, 255, 255, 0.8);
  border-radius: 40px;
